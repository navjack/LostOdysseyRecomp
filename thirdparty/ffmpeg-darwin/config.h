/* macOS (Darwin) config for the pinned Xenia FFmpeg fork (15ece0882e8d5875051ff5b73c5a8326f7cee9f5).
 * HAVE_/ARCH_ platform values: that fork's ./configure run on macOS 27 / Apple clang 21 with
 *   --arch=aarch64 --disable-asm --disable-programs --disable-doc --disable-everything --disable-iconv
 * CONFIG_ component values: copied from the fork's config_android_aarch64.h (CONFIG_PIC kept at 1).
 * No asm/NEON: every ARCH_* is 0, so FFmpeg uses its portable C paths (XMA audio decode only). */
/* Automatically generated by configure - do not modify! */
#ifndef FFMPEG_CONFIG_H
#define FFMPEG_CONFIG_H
#define FFMPEG_CONFIGURATION "--cc=/usr/bin/clang --arch=aarch64 --disable-asm --disable-programs --disable-doc --disable-everything --disable-iconv"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "Apple clang version 21.0.0 (clang-2100.3.27.1)"
